...
const AddToCartButton = ({ product, text }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`flex items-center justify-center gap-2 px-4 py-2  rounded-sm font-semibold text-sm sm:text-base transition-all duration-200
        ${
          isAdded
            ? "bg-green-100 text-green-700 border border-green-400 hover:bg-green-200 hover:text-green-800"
            : "hover:bg-pink-50 hover:text-pink-600 border border-pink-300 bg-pink-600 text-white"
        }
